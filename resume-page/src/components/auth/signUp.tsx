...
export default function SignUp() {
  ...
  return (
    <Container alignContent={"center"}>
      <Center>
        <Text height={"10vh"} paddingTop={"40px"} as="b" fontSize={"3xl"}>
          Sign up to add your pet to the Pet Quiz!
        </Text>
      </Center>
      <Center paddingTop={"20px"}>
        <Box bg="gray.100" rounded="md" width={"20vw"}>
          <Formik
            ...
            onSubmit={(values) => createUserWithEmailAndPassword(auth, values.email, values.password)
            .then((userCredential) => {
